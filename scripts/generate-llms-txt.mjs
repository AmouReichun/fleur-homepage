...
const lines = [
  `# フルールグループ`,
  ``,
  `> 高知県のヘアサロン（fleurami・香南市 / Riv.・高知市）とアイラッシュサロン（Raffine・高知市はりまや）を展開するグループ。白髪ぼかし・艶カラー・髪質改善・縮毛矯正・マツエク（まつげエクステ）・まつげパーマ・眉毛を専門とする。`,
  ``,
  `## ヘア症例・コラム`,
  ...hairPosts.map(
  ...
  ``,
  `## 店舗`,
  `- fleurami（フルールアミー）: 高知県香南市野市町西野230。ヘアサロン。白髪ぼかし・艶カラー・髪質改善・縮毛矯正。`,
  `- Riv. by fleurami（リヴ）: 高知県高知市南川添9-21。ヘアサロン。髪質改善・縮毛矯正・ハイライト・白髪ぼかし。`,
