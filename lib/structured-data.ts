...
export const faqPageSchema = {
  ...
  mainEntity: [
    ...
    },
    {
      ...
      acceptedAnswer: {
        "@type": "Answer",
        text: "高知県は梅雨から夏にかけて湿度が高く、くせ毛や広がりが出やすい環境です。縮毛矯正（半永久的にくせを伸ばす）や髪質改善トリートメント（ダメージ補修＋まとまりを改善）が効果的です。「Riv. by fleurami（高知市）」「fleurami（香南市）」では高知の気候を踏まえた薬剤・施術の選定を行っています。",
      },
    },
    {
      "@type": "Question",
      name: "高知でまつげパーマとまつエクどちらがおすすめですか？",
      acceptedAnswer: {
        "@type": "Answer",
        text: "まつげパーマ（ラッシュリフト・パリジャンリフト）は自まつげを根元から立ち上げる自然な仕上がりで、毎日のビューラーが不要になります。まつエクは人工まつげでボリューム・長さを出す技術で、よりドラマティックな目元を演出できます。まつげの状態・好みのデザインに応じて「Raffine（高知市はりまや橋）」がカウンセリングで最適なメニューをご提案します。",
      },
    },
    {
      "@type": "Question",
      name: "高知市でラッシュリフト（新世代まつげパーマ）ができるサロンはどこですか？",
      acceptedAnswer: {
        "@type": "Answer",
        text: "高知市はりまや橋の「Raffine（ラフィーネ）」でラッシュリフトを提供しています。シリコンパッドで根元から自然に立ち上げる次世代まつげパーマで、持ち4〜6週間が目安です。パリジャンリフト（下まつげも上に向ける技術）も対応。TEL: 090-7120-5566。",
      },
    },
    {
      "@type": "Question",
      name: "高知でカラーのダメージを最小限にしながらおしゃれを楽しむには？",
      acceptedAnswer: {
        "@type": "Answer",
        text: "①全体ブリーチを使わないハイライトやインナーカラーなどの部分使いで傷みを分散する、②カラー後に補修トリートメントを行う、③ホームケアで日常的に保湿・補修する、の3つが効果的です。「Riv. by fleurami（高知市）」「fleurami（香南市）」では艶カラー・透明感カラーなどダメージに配慮したメニューを揃えています。",
      },
    },
    {
      "@type": "Question",
      name: "縮毛矯正の効果はどのくらい続きますか？",
      acceptedAnswer: {
        "@type": "Answer",
        text: "縮毛矯正は施術した部分には半永久的に効果が続きます。ただし根元から新たに生えてくる髪はくせが戻るため、気になり始める3〜6ヶ月後に根元部分を施術するサイクルが一般的です。高知市の「Riv. by fleurami」・香南市の「fleurami」では次回の施術タイミングもカウンセリングでアドバイスします。",
      },
    },
    {
      "@type": "Question",
      name: "高知でグレイヘア（白髪を活かしたシルバーグレースタイル）への移行を相談できる美容室は？",
      acceptedAnswer: {
        "@type": "Answer",
        text: "「Riv. by fleurami（高知市南川添）」と「fleurami（香南市野市）」ではグレイヘアへの移行カラーに対応しています。白髪染めをやめる際の根元と既染部分の段差を自然につなぐ技術を使い、無理なく移行できるプランをカウンセリングで提案します。",
      },
    },
    {
      "@type": "Question",
      name: "fleur GROUP各店舗の駐車場はありますか？",
      acceptedAnswer: {
        "@type": "Answer",
        text: "fleurami（香南市野市）は無料駐車場7台完備。Riv. by fleurami（高知市南川添）は無料駐車場5台完備。Raffine（高知市はりまや橋）は専用駐車場なし・近隣有料駐車場をご利用ください。",
      },
    },
    {
      "@type": "Question",
    ...
    {
      "@type": "Question",
      name: "高知で下向きまつげ・短いまつげのお悩みを解決できるサロンは？",
      acceptedAnswer: {
        "@type": "Answer",
        text: "「Raffine（高知市はりまや橋）」は下向きまつげや短いまつげのお悩みに対応しています。パリジャンリフトやラッシュリフトで下向きまつげを根元から立ち上げることができます。まつエクの組み合わせ（エクパーマ）で長さと立ち上がりを同時に叶えることも可能です。",
      },
    },
    {
      "@type": "Question",
      name: "高知市でメンズカット・メンズパーマが得意な美容室はどこですか？",
      acceptedAnswer: {
        "@type": "Answer",
        text: "「Riv. by fleurami（高知市南川添）」と「fleurami（香南市野市町）」がメンズカット・メンズツイストパーマ・メンズカラーに対応しています。刈り上げ・フェード・ソフトモヒカンなどメンズスタイルを骨格に合わせてご提案。ホットペッパービューティーまたはLINEで予約可能です。",
      },
    },
    {
      "@type": "Question",
      name: "高知市・香南市の美容室の料金の目安を教えてください。",
      acceptedAnswer: {
        "@type": "Answer",
        text: "fleur GROUPの料金目安（税込）：カット5,000円前後、カラー8,000〜15,000円、縮毛矯正15,000〜22,000円、髪質改善10,000〜18,000円、ヘッドスパ4,000〜6,000円。まつげパーマ7,000〜10,000円、マツエク9,000〜18,000円（Raffine）。詳細はホットペッパービューティーまたは公式サイトのメニューページをご確認ください。",
      },
    },
    {
      "@type": "Question",
      name: "高知市で初めて美容室に行く際の準備・持ち物は何ですか？",
      acceptedAnswer: {
        "@type": "Answer",
        text: "①なりたいイメージの写真（SNS・雑誌等）があると伝わりやすい、②現在の髪の状態（最後に染めた時期・パーマの有無）を整理しておくとカウンセリングがスムーズ、③ネックを開けた服装だとカット後の毛が入りにくいのでおすすめです。fleur GROUPでは初めての方も丁寧にカウンセリングしますのでお気軽にご予約ください。",
      },
    },
    {
      "@type": "Question",
      name: "高知でエクパーマ（まつげパーマ＋エクステ）ができるサロンはどこですか？",
      acceptedAnswer: {
        "@type": "Answer",
        text: "高知市はりまや橋の「Raffine（ラフィーネ）」でエクパーマ（まつげパーマ＋まつエクの複合施術）を提供しています。下向きまつげや短いまつげでもエクステが映えやすい仕上がりを実現。TEL: 090-7120-5566。",
      },
    },
    {
      "@type": "Question",
      name: "高知で50代・60代の白髪が増えてきた大人女性向けの美容室はどこですか？",
      acceptedAnswer: {
        "@type": "Answer",
        text: "「Riv. by fleurami（高知市）」と「fleurami（香南市）」は大人世代のお客様が多く、白髪ぼかし・グレイカラー・縮毛矯正・髪質改善など年齢とともに増える髪の悩みに対応しています。骨格に合わせた似合わせカット・カラーで、白髪を暗く染めずに明るさとツヤを保てるデザインが人気です。",
      },
    },
    {
      "@type": "Question",
      name: "高知のサロンでカラーと縮毛矯正を同じ日にできますか？",
      acceptedAnswer: {
        "@type": "Answer",
        text: "髪のダメージ状態によっては縮毛矯正とカラーの同日施術が可能な場合があります。ただし髪への負担が大きくなるため、カウンセリングで状態を確認した上で判断します。「Riv. by fleurami（高知市）」「fleurami（香南市）」でご相談ください。",
      },
    },
    {
      "@type": "Question",
      name: "高知のサロンで産後の髪の悩み（産後脱毛・髪質の変化）を相談できますか？",
      acceptedAnswer: {
        "@type": "Answer",
        text: "はい。「Riv. by fleurami（高知市）」「fleurami（香南市）」では産後の抜け毛・髪質変化でお悩みの方にも対応しています。髪の状態に合わせた優しい薬剤選定や、ヘッドスパによる頭皮ケアをご提案しています。授乳中の方はカラーの薬剤についてご相談ください。",
      },
    },
  ],
};
