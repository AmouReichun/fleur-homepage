...
export const AREAS: AreaDef[] = [
    ...
    faq: [
      {
        ...
        a: "高知市南川添の「Riv. by fleurami（リヴ バイ フルールアミー）」が髪質改善トリートメントと白髪ぼかしを得意としています。カウンセリング重視で、大人女性の髪のお悩みに丁寧に対応。Googleクチコミ4.62（739件）。電話088-884-5566。",
      },
      {
  ...
  },
  {
    ...
    faq: [
      ...
      {
        q: "野市で白髪ぼかし・艶カラーができる美容室は？",
        a: "野市（香南市野市町）の「fleurami（フルールアミー）」で白髪ぼかし・艶カラー・透明感カラーに対応しています。骨格・肌色に合わせた似合わせカラーで大人女性から人気です。",
      },
      {
        q: "のいち駅から歩いて行ける美容室はありますか？",
        a: "「fleurami（フルールアミー）」は香南市野市町西野230にあります。のいち駅から車で約4分の立地で無料駐車場7台完備。徒歩でも来店可能ですが、お車でのご来店が便利です。電話：0887-56-5566。",
      },
      {
        q: "野市・野市町の美容室で初めて予約するには？",
        a: "「fleurami（フルールアミー）」はホットペッパービューティーまたはLINEからご予約いただけます。初めての方にも丁寧なカウンセリングを行い、髪のお悩みやご希望に合った施術をご提案します。",
      },
    ],
  },
  {
    ...
    faq: [
      ...
      {
        q: "はりまや橋のRaffineに電車・バスでのアクセス方法は？",
        a: "JR高知駅からとさでん交通バスまたは路面電車（土佐電鉄）で「はりまや橋」下車、徒歩3〜5分です。住所：高知市はりまや町1-4-8 TNはりまやビル3F（3階）。近隣に有料駐車場あり。電話：090-7120-5566。",
      },
      {
        q: "はりまや橋でラッシュリフト（次世代まつげパーマ）はできますか？",
        a: "「Raffine（ラフィーネ）」ではラッシュリフト・パリジャンリフトに対応しています。シリコンパッドで根元から自然に立ち上げる技術で、まつげが長く・根元がくっきり見えます。持ちは4〜6週間が目安。完全予約制。",
      },
      {
        q: "はりまや橋でLEDまつげエクステはできますか？",
        a: "「Raffine（ラフィーネ）」でLEDエクステを提供しています。短時間装着・当日メイク・当日入浴OKで持ちに優れた次世代まつげエクステです。フラットラッシュ・韓国束感との組み合わせも可能。",
      },
      {
        q: "はりまや橋のアイラッシュサロンは初めてでも大丈夫ですか？",
        a: "「Raffine（ラフィーネ）」は全席半個室で完全予約制のプライベートなサロンです。初めての方も担当アイリストが丁寧にカウンセリングを行い、まつげの状態や目の形に合わせたデザインをご提案します。",
      },
    ],
  },
];
