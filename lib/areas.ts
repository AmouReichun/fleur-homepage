...
export const AREAS: AreaDef[] = [
  {
    ...
    faq: [
      ...
      {
        q: "高知市の美容室に初めてでも予約できますか？",
        a: "はい、初めての方も歓迎しています。高知市南川添の「Riv. by fleurami」はカウンセリングを大切にしており、髪のお悩みやご希望を伺ったうえで施術内容をご提案します。ご予約はホットペッパービューティー・LINE・Web予約から承っています。",
      },
      {
        q: "カットだけでも予約できますか？",
        a: "はい、カット単体のご予約も可能です。Riv. by fleuramiでは骨格・髪質に合わせた似合わせカットをご提供しています。カラーや髪質改善との組み合わせもご相談いただけます。",
      },
      {
        q: "縮毛矯正と髪質改善はどちらを選べばいいですか？",
        a: "縮毛矯正はくせをしっかり伸ばしてまっすぐにする施術、髪質改善はくせを和らげながらダメージを補修して扱いやすくする施術です。くせの強さやなりたい仕上がりによって適した方が異なるため、Riv. by fleuramiのカウンセリングで髪の状態を確認しご提案します。",
      },
    ],
  },
  {
