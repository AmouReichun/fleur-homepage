...
const faqSchema = {
  ...
  mainEntity: [
    ...
    },
    {
      ...
      acceptedAnswer: {
        "@type": "Answer",
        text: "「Raffine（ラフィーネ）」が高知市はりまや橋周辺のアイラッシュ専門サロンです。住所：高知市はりまや町1-4-8 TNはりまやビル3F。電話：090-7120-5566。まつげパーマ（パリジャンリフト・ラッシュリフト）・まつげエクステ・眉毛WAXに特化した全席半個室の専門サロンで、Googleクチコミ4.82（200件以上）の高評価。",
      },
    },
    {
      "@type": "Question",
