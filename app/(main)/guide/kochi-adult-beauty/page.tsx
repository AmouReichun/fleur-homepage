...
const faqSchema = {
  ...
  mainEntity: [
    ...
    },
    {
      ...
      acceptedAnswer: {
        "@type": "Answer",
        text: "高知市南川添の「Riv. by fleurami」と香南市野市の「fleurami」は、40代・50代の大人女性のお客様が多く、白髪ぼかし・髪質改善・艶カラー・縮毛矯正など年齢とともに変化する髪の悩みに対応したメニューを得意としています。Googleクチコミ（Riv.:4.8/84件、fleurami:4.5/82件）の高評価もいただいています。",
      },
    },
    {
      "@type": "Question",
