...
const faqSchema = {
  ...
  mainEntity: [
    ...
    },
    {
      ...
      acceptedAnswer: {
        "@type": "Answer",
        text: "高知市はりまや橋から徒歩約3分の「Raffine（ラフィーネ）」がアイラッシュ・眉毛専門サロンです。まつげパーマ（パリジャンリフト・ラッシュリフト）・まつげエクステ・眉毛WAX（メンズ対応）に特化した全席半個室のサロンです。Googleクチコミ5.0（46件）の高評価。TEL: 090-7120-5566。",
      },
    },
    {
      "@type": "Question",
      ...
      <section className="py-12 sm:py-16 bg-white">
        <div className="max-w-4xl mx-auto px-4 sm:px-6">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            ...
            <Link href="/guide/kochi-adult-beauty" className="border border-site-greige bg-site-light p-6 hover:border-site-accent transition-colors group block">
              <span className="block text-xs tracking-[0.2em] text-site-accent mb-2 uppercase">40s・50s</span>
            ...
            <Link href="/guide/kochi-head-spa-guide" className="border border-site-greige bg-site-light p-6 hover:border-site-accent transition-colors group block">
              <span className="block text-xs tracking-[0.2em] text-site-accent mb-2 uppercase">Spa</span>
              <span className="block font-serif text-lg font-medium text-site-text group-hover:text-site-accent transition-colors mb-1">高知のヘッドスパガイド</span>
              <span className="block text-xs text-site-muted leading-relaxed">頭皮ケア・抜け毛・産後の髪の悩みとヘッドスパの効果・料金</span>
            </Link>
            <Link href="/guide/kochi-shiraga-guide" className="border border-site-greige bg-site-light p-6 hover:border-site-accent transition-colors group block">
              <span className="block text-xs tracking-[0.2em] text-site-accent mb-2 uppercase">Gray</span>
              <span className="block font-serif text-lg font-medium text-site-text group-hover:text-site-accent transition-colors mb-1">高知の白髪ぼかし・グレイカラーガイド</span>
              <span className="block text-xs text-site-muted leading-relaxed">白髪染めとの違い・頻度・グレイヘア移行・料金目安</span>
            </Link>
            <Link href="/guide/kochi-kamishitsu-kaizen-guide" className="border border-site-greige bg-site-accent/5 p-6 hover:border-site-accent transition-colors group block">
              <span className="block text-xs tracking-[0.2em] text-site-accent mb-2 uppercase">Treatment</span>
