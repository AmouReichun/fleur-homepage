...
const AREA_INTRO: Record<string, string> = {
  ...
  harimayabashi: "はりまや橋（高知市はりまや町）には、まつげ・眉毛の専門サロン「Raffine（ラフィーネ）」があります。まつげパーマ（パリジャンリフト・ラッシュリフト）・まつげエクステ・LEDエクステ・眉毛WAX（メンズ対応）をご提供しています。全席半個室のプライベートな空間で、落ち着いた雰囲気のなかで施術を受けていただけます。Googleクチコミ5.0（46件）・ホットペッパービューティー4.84（222件）の高評価サロンです。ご予約はホットペッパービューティーまたはInstagram DMから受け付けています。",
};
