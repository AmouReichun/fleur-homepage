...
const jobPostings = [
  jobPosting("美容師（スタイリスト・アシスタント）", "香南市の美容室fleuramiで美容師を募集。髪質改善・カット・艶カラーが学べる地域密着型サロン。香南市 美容室求人。完全週休2日制・社会保険完備・アシスタントから育成。未経験・ブランクOK。スタイリスト月給23万円＋歩合、アシスタント月給22万円。", "香南市", "野市町西野230", "781-5232", "美容師", 220000, 230000),
