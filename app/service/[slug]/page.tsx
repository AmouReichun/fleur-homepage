...
export function generateMetadata({ params }: Props): Metadata {
  ...
  return {
    ...
    openGraph: { title: svc.title, description: svc.description, url, images: [svc.image] },
    twitter: { card: "summary_large_image", title: svc.title, description: svc.description, images: [svc.image] },
  };
}
