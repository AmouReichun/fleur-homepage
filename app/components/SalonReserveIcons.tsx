...
function PhoneIcon() {
  return (
    <svg viewBox="0 0 24 24" className="w-5 h-5 sm:w-9 sm:h-9" fill="currentColor" aria-hidden>
...
function WebIcon() {
  return (
    <svg viewBox="0 0 24 24" className="w-5 h-5 sm:w-9 sm:h-9" fill="none" stroke="currentColor" strokeWidth="1.6" aria-hidden>
...
function channelsForSalon(s: ReserveSalon): Ch[] {
  ...
  if (s.webReserveUrl) ch.push({ kind: "web", label: `${s.name}のWeb予約`, short: "Web\n予約", href: s.webReserveUrl, external: true });
