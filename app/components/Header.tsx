          ...
          <div className="hidden lg:flex items-center gap-5 xl:gap-7">
            <nav className="flex items-center gap-5 xl:gap-7">
              {navLinks.map((link) => (
                <Link
                  key={link.href}
                  href={link.href}
                  className={`relative text-[11px] tracking-[0.08em] whitespace-nowrap transition-colors duration-400 after:absolute after:left-0 after:-bottom-1 after:h-px after:w-0 after:bg-current after:transition-all after:duration-300 hover:after:w-full ${
                    solid
            ...
            <div className="relative">
              <button
                ...
                className="px-5 py-2 rounded-full bg-site-accent text-white text-[11px] tracking-[0.18em] whitespace-nowrap hover:opacity-90 hover:scale-105 active:scale-95 transition-all duration-200"
              >
                ご予約
              </button>
              {reserveOpen && (
